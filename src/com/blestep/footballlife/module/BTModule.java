...
import com.blestep.footballlife.entity.Alarm;
        ...
        switch (header) {
            case BTConstants.HEADER_BACK_STEP:
                ...
                if (Float.valueOf(distance) != 0 && Integer.valueOf(duration) != 0) {
                    step.speed = SportDataUtils.getSpeed(Float.valueOf(distance), Float.valueOf(duration)) + "";
                } else {
                    step.speed = "0";
                }
                if (!"0".equals(step.speed)) {
                    step.power = SportDataUtils.getPower(context, Float.valueOf(step.speed)) + "";
                } else {
                    step.power = "0";
                }
