...
public abstract class PieRadarChartBase<T extends ChartData<? extends IDataSet<? extends Entry>>>
    ...
    public void calculateOffsets() {
        ...
        mViewPortHandler.restrainViewPort(offsetLeft, offsetTop + com.blestep.footballlife.utils.Utils.dip2px(getContext(), 65), offsetRight, offsetBottom);

        if (mLogEnabled)
            Log.i(LOG_TAG, "offsetLeft: " + offsetLeft + ", offsetTop: " + (offsetTop + com.blestep.footballlife.utils.Utils.dip2px(getContext(), 65))
